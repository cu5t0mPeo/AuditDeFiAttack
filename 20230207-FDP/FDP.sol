...
__________________¶¶____¶¶_________________ WELCOME TO FIREDRAKE EMPIRE
__________¶¶¶¶¶¶¶¶¶¶¶¶¶__¶¶¶¶______________Firedrake is not just a token,
______¶¶¶¶__¶¶¶¶¶¶¶¶¶¶¶¶¶¶¶________________It will be history. Let's make history come alive again by joining our league of Firedrake.
...
contract FIREDRAKE is Context, IERC20, Ownable {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        (, uint256 rTransferAmount, , uint256 tTransferAmount, , ) = _getValues(
            _tTotal
        );
